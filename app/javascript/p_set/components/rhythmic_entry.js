...
export default class RhythmicEntryComponent extends React.Component {
  ...
  getCurrentNote(measures) {
    var currentMeasure =
      this.props.currentMeasure == -1 ? 0 : this.props.currentMeasure
  ...
  render() {
    const noteOptions = this.props.options.rhythm
      .filter((x) => x[1])
      .map(([duration, _], i) => {
        return (
      ...
      <div className="row columns" ref={(el) => (this.containerEl = el)}>
        <div className="reveal" id="help-text-rhythmic" data-reveal>
          <ul>
            ...
            <li>
              <b>Up/Down - </b> arrows select note duration
            </li>
            <li>
              <b>Enter - </b> adds a note of selected duration
            </li>
            <li>
              <b>Backspace/Delete - </b> removes the last note in a measure
            </li>
            <li>
              <b>Shift+d - </b> removes a dot from the last note in a measure
            </li>
            <li>
              <b>Shift+a - </b> Plays the A above middle C for 5 seconds. Can
              also pause.
            </li>
            <li>
              <b>= - </b> Toggles note ties. A tied note will show a tie to the
              next note entered.
            </li>
            <li>
              <b>r - </b> adds a rest of selected duration
            </li>
            <li>
              <b>. - </b> adds a dot to the last note in a measure
            </li>
            <li>
              <b>&lt;/&gt; - </b> Moves up/down a stave, or cycles around
            </li>
            <br />
        ...
        <div
          ...
          style={showIf(!meterCorrect && !instructor)}
        >
          <fieldset>
            <legend>Meter</legend>
            <input
