...
ActiveRecord::Schema.define(version: 2020_12_21_180025) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "classroom_psets", id: :serial, force: :cascade do |t|
  ...
  create_table "classroom_users", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "classroom_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "exercise_categories", id: :serial, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "exercise_subcategories", id: :serial, force: :cascade do |t|
    t.string "name"
  ...
  create_table "p_set_answers", id: :serial, force: :cascade do |t|
    t.integer "p_set_id"
    t.integer "user_id"
    t.json "data"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["p_set_id", "user_id"], name: "index_p_set_answers_on_p_set_id_and_user_id", unique: true
    t.index ["p_set_id"], name: "index_p_set_answers_on_p_set_id"
    t.index ["user_id"], name: "index_p_set_answers_on_user_id"
  end

  create_table "p_set_audios", id: :serial, force: :cascade do |t|
    t.string "audio"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "p_set_to_audios", id: :serial, force: :cascade do |t|
    t.integer "p_set_id"
    t.integer "p_set_audio_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["p_set_audio_id"], name: "index_p_set_to_audios_on_p_set_audio_id"
    t.index ["p_set_id", "p_set_audio_id"], name: "index_p_set_to_audios_on_p_set_id_and_p_set_audio_id", unique: true
    t.index ["p_set_id"], name: "index_p_set_to_audios_on_p_set_id"
  end

  create_table "p_sets", id: :serial, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "user_id"
  ...
  create_table "registration_keys", id: :serial, force: :cascade do |t|
    t.string "key"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
